...
if __name__ == '__main__':
    text = load_etext(id_livro)

    Archive('C:/Users/William/gutenberg_data/text/' + str(id_livro) + '.txt.gz').extractall('Textos')

    with codecs.open('Textos/' + str(id_livro) + '.txt', 'r', encoding='utf8') as f:
        contents = f.read()
        f.close()
